...
print(u'\n\nКакую задачу хотите решить? Введите число от 1 до 4. Если список положительный, то можете выбрать 5ую задачу:')
n = int(input())
